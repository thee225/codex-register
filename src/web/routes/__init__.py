...
from .account_monitor import router as account_monitor_router
...
api_router.include_router(account_monitor_router, prefix="/account-monitor", tags=["account-monitor"])
